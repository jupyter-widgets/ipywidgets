...
### LayoutModel (@jupyter-widgets/base, 1.3.0); LayoutView (@jupyter-widgets/base, 1.3.0)

Attribute        | Type             | Default          | Help
-----------------|------------------|------------------|----
`_model_module`  | string           | `'@jupyter-widgets/base'` | The namespace for the model.
`_model_module_version` | string           | `'1.3.0'`        | A semver requirement for namespace version containing the model.
...
### ButtonStyleModel (@jupyter-widgets/controls, 2.1.0); StyleView (@jupyter-widgets/base, 1.3.0)
...
### DescriptionStyleModel (@jupyter-widgets/controls, 2.1.0); StyleView (@jupyter-widgets/base, 1.3.0)
...
### ProgressStyleModel (@jupyter-widgets/controls, 2.1.0); StyleView (@jupyter-widgets/base, 1.3.0)
...
### SliderStyleModel (@jupyter-widgets/controls, 2.1.0); StyleView (@jupyter-widgets/base, 1.3.0)
...
### ToggleButtonsStyleModel (@jupyter-widgets/controls, 2.1.0); StyleView (@jupyter-widgets/base, 1.3.0)
