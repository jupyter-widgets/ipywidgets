...
export class DummyManager extends widgets.ManagerBase<HTMLElement> {
  ...
  display_view(
      msg: services.KernelMessage.IMessage, view: Backbone.View<Backbone.Model>, options: any) {
...
class TestWidget extends widgets.WidgetModel {
  defaults() {
    return {
      ...super.defaults(), _model_module: 'test-widgets', _model_name: 'TestWidget',
          _model_module_version: '1.0.0', _view_module: 'test-widgets',
          _view_name: 'TestWidgetView', _view_module_version: '1.0.0', _view_count: null,
    }
  }
}
...
class BinaryWidget extends TestWidget {
  static serializers = {...widgets.WidgetModel.serializers, array: array_serialization};
  defaults() {
    return {
      ...super.defaults(),
