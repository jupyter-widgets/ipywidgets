...
export namespace shims {
  export namespace services {
    ...
    export class CommManager {
       ...
       * @return {Comm}
       */
      new_comm(target_name: string, data: any, callbacks: any, metadata: any, comm_id: string):
          Comm {
      ...
      register_target(target_name, f) {
        var handle =
            this.jsServicesKernel.registerCommTarget(target_name, (jsServicesComm, msg) => {
              // Create the comm.
    ...
    export class Comm {
       ...
       * @return message id
       */
      send(data: any, callbacks: any, metadata: any, buffers: ArrayBuffer[]|ArrayBufferView[]):
          string {
      ...
      _hookupCallbacks(future: Kernel.IFuture, callbacks: any) {
        if (callbacks) {
          future.onReply = function(msg) {
            ...
            // TODO: Handle payloads.  See
            // https://github.com/jupyter/notebook/blob/master/notebook/static/services/kernels/kernel.js#L923-L947
          };
