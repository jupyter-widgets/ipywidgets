...
namespace shims {
  ...
  namespace services {
    ...
    class CommManager {
       ...
       * @return {Comm}
       */
      new_comm(target_name: string, data: any, callbacks: any, metadata: any,
               comm_id: string): Comm {
    ...
    class Comm {
       ...
       * @return message id
       */
      send(data: any, callbacks: any, metadata: any,
           buffers: ArrayBuffer[] | ArrayBufferView[]): string {
      ...
      _hookupCallbacks(future: Kernel.IFuture, callbacks: any) {
        if (callbacks) {
          future.onReply = function(msg) {
            ...
            // See https://github.com/jupyter/notebook/blob/master/notebook/static/services/kernels/kernel.js#L923-L947
          };
