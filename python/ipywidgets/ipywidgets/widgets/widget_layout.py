...
from traitlets import CaselessStrEnum, Instance, Unicode, validate
...
class Layout(Widget):
    ...
    border_right = Unicode(None, allow_none=True, help="The border right CSS attribute.").tag(
        sync=True
    )
    border_bottom = Unicode(None, allow_none=True, help="The border bottom CSS attribute.").tag(
        sync=True
    )
    border_left = Unicode(None, allow_none=True, help="The border left CSS attribute.").tag(
        sync=True
    )
    ...
    object_position = Unicode(None, allow_none=True, help="The object-position CSS attribute.").tag(
        sync=True
    )
    ...
    grid_auto_rows = Unicode(None, allow_none=True, help="The grid-auto-rows CSS attribute.").tag(
        sync=True
    )
    ...
    grid_column = Unicode(None, allow_none=True, help="The grid-column CSS attribute.").tag(
        sync=True
    )
