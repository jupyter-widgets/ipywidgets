...
class TestTwoByTwoLayout(TestCase):
    ...
    def test_merge_cells(self):  # pylint: disable=no-self-use
        ...
        box = widgets.TwoByTwoLayout(
            top_left=button1, top_right=button2, bottom_left=button3, bottom_right=button4
        )
        ...
        box = widgets.TwoByTwoLayout(
            top_left=None, top_right=button1, bottom_left=None, bottom_right=None, merge=False
        )
...
class TestAppLayout(TestCase):
    ...
    def test_merge_empty_cells(self):
        ...
        box = widgets.AppLayout(
            header=header, footer=footer, center=None, left_sidebar=None, right_sidebar=None
        )
        ...
        box = widgets.AppLayout(
            footer=footer, center=center, left_sidebar=left_sidebar, right_sidebar=right_sidebar
        )
        ...
        box = widgets.AppLayout(
            header=header, center=center, left_sidebar=left_sidebar, right_sidebar=right_sidebar
        )
...
class TestGridspecLayout(TestCase):
    ...
    def test_setitem_index(self):
        ...
        assert box.layout.grid_template_areas == f'''"{button1_label} . ."\n". . ."'''
