...
class Widget(LoggingConfigurable):
    ...
    def _ipython_display_(self, **kwargs):
        ...
        if self._view_name is not None:
            ...
            # The vnd.jupyter.widget mimetype has not been registered yet. See the 
            # registration process and naming convention at http://tools.ietf.org/html/rfc6838 
            # and the currently registered mimetypes at 
            # http://www.iana.org/assignments/media-types/media-types.xhtml
            # We don't have a 'text/plain' entry so that this will be invisible in the
            # current notebook.
            data = {
                'application/vnd.jupyter.widget': self._model_id
            }
