...
def _binary_to_json(x, obj, buffers):
...
def _json_to_binary(x, obj, buffers):
    # TODO: Deserialize lists/dicts of buffers
...
binary_serialization = {
    'from_json': _json_to_binary,
    'to_json': _binary_to_json
}
